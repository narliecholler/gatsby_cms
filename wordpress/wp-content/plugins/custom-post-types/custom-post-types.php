...
<?php }
        ...
        public function init_field_ui(){
            $labels = array(
                'name'               => __( 'Custom fields groups', 'custom-post-types' ),
                ...
                'all_items'          => __( 'Custom fields groups', 'custom-post-types' ),
            ...
            $args = array(
                'labels'             => $labels,
                'description'        => __( 'Create and manage custom fields groups.', 'custom-post-types' ),
                'public'             => false,
                'publicly_queryable' => false,
                'show_ui'            => true,
                'show_in_menu'       => true,
...
<?php update_option('fantastic_plugins_notices', strtotime("+1 day", time()) ); }


            if(!isset($_COOKIE[ $this->cpt_ui_name . '_notices_close'])) { ?>
<?php 
                if( !$this->is_pro_version_active() ) {
                    printf( '<div class="%1$s"><p>%2$s<br><strong><a href="%3$s" target="_blank">%4$s</a></strong> - <a href="%5$s" target="_blank">%6$s</a> - <a href="%7$s" target="_blank">%8$s</a> - <a href="#" class="%9$s-notices-close">%10$s</a></p></div>', $this->cpt_ui_name . '-notices notice notice-success is-dismissible', __( '<strong>Custom post type</strong> notice:<br>Thanks for using this plugin! Do you want to help us grow to add new features?', 'custom-post-types' ) , 'https://www.andreadegiovine.it/risorse/plugin/custom-post-types?utm_source=tools_plugin_page&utm_medium=plugin_page&utm_campaign=custom_post_types', __( 'Become PRO', 'custom-post-types' ), 'https://wordpress.org/support/plugin/custom-post-types/reviews/#new-post', __( 'Review', 'custom-post-types' ), 'https://www.andreadegiovine.it/outlinks/1422/?utm_source=wordpress_dashboard&utm_medium=notices&utm_campaign=custom_post_types', __( 'Send donation', 'custom-post-types' ), $this->cpt_ui_name, __( 'Close and don\'t show again', 'custom-post-types' ) );
                } else {
